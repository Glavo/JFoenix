...
public class JFXComboBoxListViewSkin<T> extends ComboBoxListViewSkin<T> {
    ...
    public JFXComboBoxListViewSkin(final JFXComboBox<T> comboBox) {
        ...
        registerChangeListener(comboBox.disableProperty(), linesWrapper::updateDisabled);
        registerChangeListener(comboBox.focusColorProperty(), linesWrapper::updateFocusColor);
        registerChangeListener(comboBox.unFocusColorProperty(), linesWrapper::updateUnfocusColor);
        registerChangeListener(comboBox.disableAnimationProperty(), errorContainer::updateClip);
    }
