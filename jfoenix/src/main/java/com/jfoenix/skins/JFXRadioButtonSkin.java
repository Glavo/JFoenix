...
public class JFXRadioButtonSkin extends RadioButtonSkin {
    ...
    public JFXRadioButtonSkin(JFXRadioButton control) {
        ...
        registerChangeListener(control.selectedColorProperty(), this::updateColors);
        registerChangeListener(control.unSelectedColorProperty(), this::updateColors);
        registerChangeListener(control.selectedProperty(), () -> {
            // update ripple color
