...
import com.jfoenix.adapters.skins.SpinnerSkin;
 ...
 * @since 2017-09-25
 */
public class JFXSpinnerSkin extends SpinnerSkin {
    ...
    public JFXSpinnerSkin(JFXSpinner control) {
        ...
        // register listeners
        registerChangeListener(control.indeterminateProperty(), this::initialize);
        registerChangeListener(control.progressProperty(), this::updateProgress);
        registerChangeListener(control.visibleProperty(), this::updateAnimation);
        registerChangeListener(control.parentProperty(), this::updateAnimation);
        registerChangeListener(control.sceneProperty(), this::updateAnimation);
    }
