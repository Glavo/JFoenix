...
public class JFXTextAreaSkin extends TextAreaSkin {
    ...
    public JFXTextAreaSkin(JFXTextArea textArea) {
        ...
        registerChangeListener(textArea.disableProperty(), () -> linesWrapper.updateDisabled());
        registerChangeListener(textArea.focusColorProperty(), () -> linesWrapper.updateFocusColor());
        registerChangeListener(textArea.unFocusColorProperty(), () -> linesWrapper.updateUnfocusColor());
        registerChangeListener(textArea.disableAnimationProperty(), () -> errorContainer.updateClip());
