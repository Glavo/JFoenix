...
import com.jfoenix.adapters.skins.RadioButtonSkin;
...
public class JFXRadioButtonSkin extends RadioButtonSkin {
    ...
    public JFXRadioButtonSkin(JFXRadioButton control) {
        ...
        registerChangeListener2(control.selectedColorProperty(), "SELECTED_COLOR", () -> {
            // update animation
            updateAnimation();
        ...
        registerChangeListener2(control.unSelectedColorProperty(), "UNSELECTED_COLOR", () -> {
            // update animation
            updateAnimation();
            // update current colors
            boolean isSelected = getSkinnable().isSelected();
        ...
        registerChangeListener2(control.selectedProperty(), "SELECTED", () -> {
            // update ripple color
            boolean isSelected = getSkinnable().isSelected();
            Color unSelectedColor = ((JFXRadioButton) getSkinnable()).getUnSelectedColor();
            Color selectedColor = ((JFXRadioButton) getSkinnable()).getSelectedColor();
